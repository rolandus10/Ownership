...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm">
    <form action="objet_valeur.html" method="post" class="form-inline my-2 my-lg-0">
      <input value="Nouvel objet" class="btn btn-outline-success my-2 my-sm-0" type="submit"></input>
    </form>
    </div>
    <div class="col-sm">
